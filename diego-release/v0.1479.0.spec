...
diego.bbs.sql.db_connection_string:
  description: 'EXPERIMENTAL: Connection string to use for SQL backend (for example,
    username:password@tcp(1.1.1.1:1234)/database)'
  default: null
diego.bbs.sql.db_driver:
  description: 'EXPERIMENTAL: Database driver to use for SQL backend (for example:
    mysql,postgres)'
  default: mysql
