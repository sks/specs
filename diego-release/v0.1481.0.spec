...
diego.bbs.sql.ca_cert:
  description: Bundle of CA certificates for the BBS to verify the SQL server SSL
    certificate when connecting via SSL
  default: null
diego.bbs.sql.db_connection_string:
  description: Connection string to use for SQL backend (for example, username:password@tcp(1.1.1.1:1234)/database)
  default: null
...
diego.rep.trusted_certs:
  description: Concatenation of trusted CA certificates to be made available on the
    cell.
  default: null
diego.rep.use_azure_fault_domains:
  description: Use Azure Fault-Domains to determine the value of the zone. The value
    of the zone will be z<FD-index>. e.g. z0, z1, etc.
  default: false
diego.rep.zone:
