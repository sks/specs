...
router.extra_headers_to_log:
  ...
  default: []
router.haproxy.faux_port:
  description: Port that HAProxy listens on when it comes up for first time to make
    sure HAProxy process is started
  default: 1234
...
uaa.id_token.disable:
  description: When set to true, requests to /oauth/authorize will ignore the response_type=id_token
    parameter
  default: true
uaa.issuer:
...
uaa.ldap.attributeMappings:
  description: Specifies how UAA user attributes map to LDAP attributes
  default: null
