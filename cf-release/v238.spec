...
routing_api.etcd.servers:
  description: When require_ssl:false this should be an array of IP addresses for
    the etcd cluster. When require_ssl:true, this should be the internal DNS name
