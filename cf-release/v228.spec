...
acceptance_tests.include_diego_docker:
  description: Flag to include v3 API tests related to running Docker apps on Diego.
    Diego must be deployed and the CC API docker_diego feature flag must be enabled
...
login.saml.entity_base_url:
  ...
  default: null
login.saml.entityid:
  description: This is used as the SAML Service Provider Entity ID
  default: null
...
uaa.scim.userids_enabled:
  ...
  default: true
uaa.scim.users:
  description: 'A list of users to be bootstrapped with default authority. Each entry
    has the following format: username|password|email|firstName|lastName'
  default: null
uaa.spring_profiles:
